...
class SpiralScanController(QObject):
    ...
    def __init__(self, calibration, af_controller, move_to_ctrl,
        ...
        self._output_base = os.path.expanduser("~/Desktop/Users/demo_scan")
        self._z_log_path = ""
    ...
    def _stitch_cycle(self):
        ...
        try:
            ...
            cycle_dir = os.path.join(self._output_base, f"demo_{self._cycle_count:04d}")
    ...
    def _capture_current_tile(self, col, row):
        try:
            ...
            d = os.path.join(self._output_base, f"demo_{self._cycle_count:04d}")
